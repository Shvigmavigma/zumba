export const messages = {
  ru: {
    ...
    adminUsers: {
      ...
      weatherImagesHint: 'Выберите изображение для каждого состояния. В карточке гонки показывается состояние с самой высокой вероятностью.',
  ...
  en: {
    ...
    adminUsers: {
      ...
      weatherImagesHint: 'Choose an image for each condition. Race cards show the condition with the highest probability.',
