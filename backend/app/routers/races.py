        ...
        rows.append(
            {
                ...
                "exclude_from_rer": user.exclude_from_rer if user else False,
        ...
        result_rows.append(
            {
                ...
                "pilot_roles": driver.get("pilot_roles") if driver else [],
                "exclude_from_rer": driver.get("exclude_from_rer", False) if driver else False,
